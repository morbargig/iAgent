...
const translations: Translation = {
  ...
  files: {
    ...
    // Upload options
    connectToDrive: 'Connect to Drive',
    linkUpload: 'Link',
    website: 'Website',
    youtube: 'YouTube',
    ...
    uploadSourcesDescription: 'Sources let NotebookLM base its responses on the information that matters most to you.',
    uploadSourcesExamples: '(Examples: marketing plans, course reading, research notes, meeting transcripts, sales documents, etc.)',
    dragDropOrChoose: 'Drag and drop or choose file to upload',
