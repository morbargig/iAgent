...
export interface StorageConfig<LocalStorageKeys extends string, LocalStorageValues extends Record<LocalStorageKeys, unknown>, SessionStorageKeys extends string, SessionStorageValues extends Record<SessionStorageKeys, unknown>> {
    localStorage: {
