const e={common:{welcome:"Welcome",language:"Language",mockApi:"Mock API",enableMockApi:"Enable Mock API",disableMockApi:"Disable Mock API",newChat:"New chat",deleteChat:"Delete Chat",edit:"Edit",delete:"Delete",share:"Share",refresh:"Refresh",send:"Send",stop:"Stop",discard:"Discard",loading:"Loading...",copy:"Copy",copied:"Copied!",more:"More",like:"Like",dislike:"Dislike",rawKeys:"Raw Keys",thinking:"Thinking..."},header:{title:"AI Assistant",subtitle:"Your intelligent conversation partner",changeLanguage:"Change Language"},errors:{loading:"Error loading translations",unsupported:"Unsupported language",failedToLoad:"Failed to load content",tryAgain:"Please try again",general:"An error occurred",network:"Network error",streaming:"Streaming error: {{error}}",chatError:"Sorry, I encountered an error. Please try again."},chat:{placeholder:"Message AI Assistant...",emptyState:"Your conversations will appear here",emptyStateSuggestion1:"What can you help me with?",emptyStateSuggestion2:"Tell me about yourself",thinking:"Thinking...",error:"Sorry, I encountered an error. Please try again.",shareTitle:"Chat Message",copySuccess:"Message copied to clipboard",copyError:"Failed to copy message",deleteConfirm:"Are you sure you want to delete this message?",editConfirm:"Are you sure you want to edit this message?",shareSuccess:"Message shared successfully",shareError:"Failed to share message",suggestions:{title:"Start a conversation",items:["Explain quantum computing","Write a creative story","Help with coding","Plan a trip"]},welcome:{title:"Welcome to AI Assistant",subtitle:"How can I help you today?",description:"I can help you with questions, writing, analysis, coding, and creative projects."},disclaimer:"AI can make mistakes. Check important info.",typing:"AI is typing..."},theme:{light:"Light mode",dark:"Dark mode"},message:{user:"You",assistant:"Assistant",streaming:"Streaming...",copy:"Copy message",copied:"Copied!",refresh:"Refresh message",edit:"Edit message",delete:"Delete message",share:"Share message",more:"More actions",like:"Like",dislike:"Dislike",removeLike:"Remove like",removeDislike:"Remove dislike",goodResponse:"Good response",badResponse:"Bad response",regenerateResponse:"Regenerate response"},sidebar:{newChat:"New chat",newChatTitle:"New Chat",conversations:"Conversations",emptyState:"Your conversations will appear here",deleteConversation:"Delete conversation"},input:{placeholder:"Message AI Assistant...",disclaimer:"AI can make mistakes. Check important info.",send:"Send message",stop:"Stop generation"},actions:{toggleSidebar:"Toggle sidebar",toggleTheme:"Toggle theme",newConversation:"New conversation",deleteConversation:"Delete conversation",shareConversation:"Share conversation",exportConversation:"Export conversation"},mock:{greeting:`Hello! I'm an AI assistant created by Anthropic. I'm here to help you with a wide variety of tasks including:
...
//# sourceMappingURL=en-D9gDZP6N.js.map
